...
import hotelinfoServicesData from './data/hotelinfo_services.json'
import hotelinfoAccessibilityData from './data/hotelinfo_accessibility.json'
        ...
        <div className="scene" id="hotelinfo">
              ...
              <article id="usefulinfo">
                ...
                <section className="checklist" id="accessibility">
                  ...
                  <ul>
                  {
                      hotelinfoAccessibilityData.map((accessibility) =>
                      <li>{accessibility.li}</li>
                    )
                    }
